...
```shell
npm install js-constant-compressor --save-dev
```
...
### Overview
In your project's Gruntfile, add a section named `js_constant_compressor` to the data object passed into `grunt.initConfig()`.
